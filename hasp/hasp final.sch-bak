...
U 1 1 61FE995B
P 1950 3000
F 0 "BT2032" H 2068 3096 50  0000 L CNN
...
Wire Wire Line
	9750 800  9750 3000
Wire Wire Line
	10000 1000 10000 4100
Wire Wire Line
	10200 1200 10200 5000
Wire Wire Line
...
F 1 "BC818" H 6291 3255 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 6300 3225 50  0001 L CIN
F 3 "https://www.onsemi.com/pub/Collateral/BC818-D.pdf" H 6100 3300 50  0001 L CNN
	1    6100 3300
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Regulator 1st stage 12v 2amp\n
Text Notes 7200 3200 0    50   ~ 0
Regulator 2nd stage 5v 2 amp\n
Text Notes 6850 4350 0    50   ~ 0
Regulator 3rd stage 3.3v 2 amp\n
...
F 1 "+VDC" H 10500 1075 50  0000 C CNN
...
F 1 "GNDREF" H 10755 3077 50  0000 C CNN
...
Serial Out/In 3 sets
Text Notes 1650 6950 0    50   ~ 0
To Data Logger + additional pins\n
Text Notes 1800 950  0    50   ~ 0
5 Volt Main Power Rail\n
Text Notes 2800 1150 0    50   ~ 0
3.3 Volt Main Power Rail\n
Text Notes 11100 1800 1    50   ~ 0
Hasp Gondola Edac Port\n
Text Notes 11100 3050 1    50   ~ 0
Hasp Gondola Edac Port\n
Text Notes 750  7100 0    50   ~ 0
Serial interfaces with db9 hasp serial interface
Connection ~ 10500 1900
Connection ~ 10500 2000
Text Notes 6050 4050 1    50   ~ 0
To Heating Pad\n
$EndSCHEMATC
